 ...
 */
static const uint8_t PROGMEM factory_key_table[18 * 8] = {
    // Row 0
    KEY_RIGHT, KEY_NONE, KEY_LEFT_GUI, KEY_BACKSLASH,
    KEY_LEFT_BRACE, KEY_MINUS, KEY_BACKSPACE, KEY_LEFT,
    // Row 1
    KEY_END, KEY_N, KEY_M, KEY_COMMA,
    KEY_PERIOD, KEY_QUOTE, KEY_RIGHT_SHIFT, KEY_NONE,
    // Row 2
    KEY_NONE, KEY_Y, KEY_U, KEY_I,
    KEY_O, KEY_P, KEY_MUTE, KEY_NONE,
    // Row 3
    KEY_NONE, KEY_F7, KEY_F8, KEY_F9,
    KEY_F10, KEY_F11, KEY_F12, KEY_NONE,
    // Row 4
    KEY_MENU, KEYPAD_MINUS, KEYPAD_1, KEYPAD_2,
    ...
    // Row 6
    KEY_NONE, KEY_VOLUME_UP, KEY_A, KEY_S,
    ...
    KEY_SLASH, KEY_RIGHT_GUI, KEY_NONE, KEY_UP,
    // Row 9
    KEY_DOWN, KEY_H, KEY_J, KEY_K,
    KEY_L, KEY_SEMICOLON, KEY_VOLUME_DOWN, KEY_NONE,
    // Row 10
    ...
    KEY_C, KEY_V, KEY_B, KEY_TAB,
    // Row 14
    KEY_NONE, KEY_NON_US_BACKSLASH, KEY_Q, KEY_W,
    KEY_E, KEY_R, KEY_T, KEY_NONE,
    // Row 15
    KEY_NONE, KEY_F1, KEY_F2, KEY_F3,
    KEY_F4, KEY_F5, KEY_F6, KEY_NONE,
    // Row 16
    KEY_ENTER, KEY_NONE, KEY_NONE, KEY_LEFT_CTRL,
    KEY_NONE, KEY_NONE, KEY_NONE, KEY_RIGHT_CTRL,
    // Row 17
    KEY_LEFT_ALT, KEY_NONE, KEY_NONE, KEY_NONE,
    KEY_RIGHT_ALT, KEY_NONE, KEY_NONE, KEY_HOME,
};
static const uint8_t PROGMEM factory_modifier_table[18 * 8] = {
    0, 0, MOD_LEFT_GUI, 0, 0, 0, 0, 0,  // Row 0
    ...
    0, 0, 0, 0, 0, MOD_RIGHT_GUI, 0, 0,  // Row 8
    ...
    0, 0, 0, MOD_LEFT_CTRL, 0, 0, 0, MOD_RIGHT_CTRL,  // Row 16
    MOD_LEFT_ALT, 0, 0, 0, MOD_RIGHT_ALT, 0, 0, 0,  // Row 17
};
#endif

/*
 * My preferred keyboard layout
 */
